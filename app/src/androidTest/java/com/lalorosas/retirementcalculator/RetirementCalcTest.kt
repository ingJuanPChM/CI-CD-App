...
/*
        ...
        val textView = onView(
            allOf(
                ...
                withText("At the current rate of 3.0%, saving $200.0 a month you will have $${"x"} by 65."),
                withParent(withParent(withId(android.R.id.content))),
                isDisplayed()
            )
        )
        textView.check(matches(withText("At the current rate of 3.0%, saving $200.0 a month you will have $${"x"} by 65.")))
*/
    }
